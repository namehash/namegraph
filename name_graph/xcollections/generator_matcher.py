...
from name_graph.xcollections.matcher import CollectionMatcher
...
from name_graph.utils import OrderedSet
...
class CollectionMatcherForGenerator(CollectionMatcher):
    def _search_for_generator(
        ...
        try:
            ...
            logger.error(f'Elasticsearch search failed [collections name_graph]', exc_info=True)
