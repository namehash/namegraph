...
class Wikipedia2VGenerator(NameGenerator):
    ...
    def __init__(self, config):
        ...
        try:
            ...
            print('No embeddings in binary format. Run name_graph/download.py.', file=sys.stderr)
            raise FileNotFoundError('No embeddings in binary format. Run name_graph/download_from_s3.py.')
